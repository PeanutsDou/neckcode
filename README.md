...
| 版本 | 下载 |
|------|------|
| 最新版 | [GitHub Releases](https://github.com/PeanutsDou/deepseekcode/releases/latest) |
| 国内加速 | [ghproxy 镜像](https://ghproxy.com/https://github.com/PeanutsDou/deepseekcode/releases/latest/download/DeepSeek-Code-Setup-0.1.0.exe) |

下载 `.exe` 安装包，双击安装即可。应用内置自动更新，后续版本会自动推送。
